<template>
  <div class="bg-[url('../../assets/auth-register.jpg')] bg-center bg-no-repeat bg-cover"></div>
    ...
    <div class="space-y-5 font-primary p-3 w-full">
      ...
      <div class="flex flex-col justify-center space-y-6 items-center mx-10">
        ...
        <div class="flex items-center gap-8 w-full mt-5">
          <u-button icon="i-flat-color-icons-google" variant="outline" size="xl" to="/google.com" class="flex-1 justify-center">Sign up with Google</u-button>

          <u-button icon="i-logos-google-gmail" variant="outline" size="xl" to="/gmail.com" class="flex-1 justify-center">Sign up with Gmail</u-button>
        </div>
          ...
          <form @submit.prevent="onSubmit" class="flex flex-col space-y-6 w-full">
            <div class="flex items-start gap-2">
              ...
              <div class="flex flex-col gap-0.5 flex-1">
                ...
                <input
                  id="firstname"
                  :class="cn('bg-white border-b-2 border-gray-400 h-[35px] w-full appearance-none px-[10px] text-sm leading-none outline-none selection:color-white selection:bg-blackA9')"
                  type="text"
            ...
            <u-button type="submit" :loading="isLoading" size="xl" class="flex justify-center !bg-black cursor-pointer hover:bg-black/80 active:bg-black">Create Account</u-button>
          </form>
        </client-only>
...
const onSubmit = handleSubmit(async values => {
  try {
    ...
    console.log(error);
    formError.value = error.data?.message || error.message || 'Something went wrong';
  } finally {
