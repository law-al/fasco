    ...
    <div class="min-h-[500px] flex flex-col items-center justify-center mx-10">
      <transition name="fade" mode="out-in">
        <div v-if="resetinkIsSent" class="flex flex-col items-center gap-4">
          <img src="../../assets/icons/icons-checkmark-100.png" alt="checkMark" class="" />

          <p class="text-2xl">Password reset link sent. Please check your mail</p>
        ...
        <div v-else class="flex flex-col justify-center space-y-2 items-center mx-10 w-full">
          ...
          <client-only>
            ...
            <form @submit.prevent="onSubmit" class="flex flex-col space-y-6 w-full">
              ...
              <u-button type="submit" :loading="isLoading" size="xl" class="flex justify-center !bg-black cursor-pointer hover:bg-black/80 active:bg-black">Send confirmation mail</u-button>
            </form>
          </client-only>
